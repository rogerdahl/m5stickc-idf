...
uint8_t axp192_init_register_list[ AXP192_INIT_REG_COUNT * 2 ] = {
    // OLED_VPP enable
    ...
    ADC_ENABLE_1_REG, BIT7 | BIT6 | BIT5 | BIT4 | BIT3 | BIT2 | BIT1 | BIT0, //3
    ...
    CHARGE_CONTROL_1_REG, BIT7 | BIT6 | BIT0, //4
    ...
    COULOMB_COUNTER_CONTROL_REG, BIT7, //5
    ...
    DCDC1_DCDC3_LDO2_LDO3_SWITCH_CONTROL_REG, BIT6 | BIT4 | BIT3 | BIT0, // 0x4D, //6
    ...
    PEK_SETTING_REG, BIT3 | BIT2, // 0x0C, //7
    ...
    VBUS_IPSOUT_PATH_SETTING_REG, BIT7 | BIT6 | BIT5 | BIT3 | BIT2, //9
    ...
    //
    BATTERY_CHARGING_HIGH_TEMPERATURE_ALARM_REG, 0xFC, //10
    ...
    BACKUP_BATTERY_CHARGING_CONTROL_REG, BIT7 | BIT5 | BIT1, //11
    ...
    VOFF_SHUTDOWN_VOLTAGE_SETTING_REG, 0x00, //12
};
...
esp_err_t m5power_init(m5power_config_t * config) {
    ...
    for ( i = 0; i < AXP192_INIT_REG_COUNT; i += 2 )
    {
        e = m5power_register_write( axp192_init_register_list[ i ], axp192_init_register_list[ i + 1 ] );
        if (e != ESP_OK)
        {
